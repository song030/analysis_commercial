...
namespace analysis_paris.DAO {
    ...
    public class SellingArea {
        ...
        public Dictionary<string, Tuple<string, string>> GetAttributes() {
            ...
            resultDict.Add("CURRENT_STATE", new Tuple<string, string>("현재 상태", this.CURRENT_STATE.ToString()));
            resultDict.Add("ADDRESS", new Tuple<string, string>("주소", this.ADDRESS.ToString()));
            resultDict.Add("AREA_SIZE", new Tuple<string, string>("매물 면적", this.AREA_SIZE.ToString()));
            //resultDict.Add("FLOOR_INFO", new Tuple<string, string>("층 수", this.FLOOR_INFO.ToString()));
            resultDict.Add("DEPOSIT", new Tuple<string, string>("보증금", this.DEPOSIT.ToString()));
            resultDict.Add("RATE_PER_MONTH", new Tuple<string, string>("월세", this.RATE_PER_MONTH.ToString()));
            resultDict.Add("PREMIUM", new Tuple<string, string>("권리금", this.PREMIUM.ToString()));
            //resultDict.Add("LATITUDE", new Tuple<string, string>("위도", this.LATITUDE.ToString()));
            //resultDict.Add("LONGITUDE", new Tuple<string, string>("경도", this.LONGITUDE.ToString()));
            //resultDict.Add("RELATION_LINK", new Tuple<string, string>("관련 링크", this.RELATION_LINK.ToString()));
            resultDict.Add("SELLING_PRICE", new Tuple<string, string>("매매가", this.SELLING_PRICE.ToString()));
            resultDict.Add("RIVAL_CNT_300", new Tuple<string, string>("반경 300m 내 경쟁업체 수(개)", this.RIVAL_CNT_300.ToString()));
            resultDict.Add("TOUR_CNT_300", new Tuple<string, string>("반경 300m 내 관광지 수(개)", this.TOUR_CNT_300.ToString()));
            resultDict.Add("HOSPITAL_CNT_300", new Tuple<string, string>("반경 300m 내 병원 수(개)", this.HOSPITAL_CNT_300.ToString()));
            resultDict.Add("STOP_CNT_300", new Tuple<string, string>("반경 300m 내 버스 정류장 수(개)", this.STOP_CNT_300.ToString()));
            resultDict.Add("LIVING_CNT_300", new Tuple<string, string>("반경 300m 내 거주세대 수(세대)", this.LIVING_CNT_300.ToString()));
            resultDict.Add("PARKING_CNT_300", new Tuple<string, string>("반경 300m 내 주차장 수(개)", this.PARKING_CNT_300.ToString()));
            resultDict.Add("STATION_CNT_300", new Tuple<string, string>("반경 300m 내 지하철역 수(개)", this.STATION_CNT_300.ToString()));
            resultDict.Add("SCHOOL_CNT_300", new Tuple<string, string>("반경 300m 내 학교 수(개)", this.SCHOOL_CNT_300.ToString()));
            resultDict.Add("ACADEMY_CNT_300", new Tuple<string, string>("반경 300m 내 학원 수(개)", this.ACADEMY_CNT_300.ToString()));
            resultDict.Add("CROSSWALK_CNT_300", new Tuple<string, string>("반경 300m 내 횡단보도 수(개)", this.CROSSWALK_CNT_300.ToString()));
            return resultDict;
        }
    }
